...
def rerank_documents(query: str, documents: list[str], top_n: int = 5) -> list[str]:
    ...
    FlashRank uses a Cross-Encoder approach which is musch more precise but usually slow.
    ...
    try:
        ...
        # Results are return sorted by highest semantic score first
        reranked_docs = []
        ...
        logfire.error(f"❌ [Reranker] Semanic Reranking Failed: {e}")
        # Fallback to the original Qdrant order to ensure the user will gets an answer
